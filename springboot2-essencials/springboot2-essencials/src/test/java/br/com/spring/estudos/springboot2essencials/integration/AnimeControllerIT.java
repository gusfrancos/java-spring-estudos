package br.com.spring.estudos.springboot2essencials.integration;
...
import br.com.spring.estudos.springboot2essencials.repository.DevDojoUserRepository;
...
import br.com.spring.estudos.springboot2essencials.util.AnimePostRequestBodyCreator;
import br.com.spring.estudos.springboot2essencials.wrapper.PageableResponse;
...
class AnimeControllerIT {
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:"+port)
                    .basicAuthentication("gustavo", "academy");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
